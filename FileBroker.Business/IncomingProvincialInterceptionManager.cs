...
public class IncomingProvincialInterceptionManager : IncomingProvincialManagerBase
{
                                                                        ...
                                                                        base(db, foaeaApis, fileName, config)
    {
        ...
        EnfSrv_Cd = provinceCode + "01"; // TODO: handle courts and others (e.g. ON02)? 
    }
    ...
    private static void ValidateActionCode(MEPInterception_RecType10 data, ref MessageDataList result, ref bool isValid)
    {
        ...
        else if ((actionCode == "C") && (actionState.NotIn(LIFESTATE_00, LIFESTATE_0, LIFESTATE_CANCEL,
                                                           LIFESTATE_VARY, LIFESTATE_TRANSFER, LIFESTATE_SUSPEND)))
            validActionLifeState = false;
                                                                          ...
                                                                          FileAuditData fileAuditData)
    {
        ...
        bool isVariation = baseData.dat_Appl_LiSt_Cd == LIFESTATE_VARY;
        bool isCancelOrSuspend = baseData.dat_Appl_LiSt_Cd.In(LIFESTATE_CANCEL, LIFESTATE_SUSPEND);
        bool isCreate = false;
