...
namespace CompareOldAndNewData.CommandLine
{
    internal static class CompareAppl
    {
                                         ...
                                         string enfSrv, string ctrlCd)
        {
            ...
            if (appl2.Appl_Rcptfrm_Dte != appl3.Appl_Rcptfrm_Dte) diffs.Add(new DiffData(tableName, key: key, colName: "Appl_Rcptfrm_Dte", goodValue: appl2.Appl_Rcptfrm_Dte, badValue: appl3.Appl_Rcptfrm_Dte));
            ...
            if (appl2.Appl_RecvAffdvt_Dte != appl3.Appl_RecvAffdvt_Dte) diffs.Add(new DiffData(tableName, key: key, colName: "Appl_RecvAffdvt_Dte", goodValue: appl2.Appl_RecvAffdvt_Dte, badValue: appl3.Appl_RecvAffdvt_Dte));
            ...
            if (appl2.Appl_Create_Dte != appl3.Appl_Create_Dte) diffs.Add(new DiffData(tableName, key: key, colName: "Appl_Create_Dte", goodValue: appl2.Appl_Create_Dte, badValue: appl3.Appl_Create_Dte));
            ...
            if (appl2.Appl_LastUpdate_Dte != appl3.Appl_LastUpdate_Dte) diffs.Add(new DiffData(tableName, key: key, colName: "Appl_LastUpdate_Dte", goodValue: appl2.Appl_LastUpdate_Dte, badValue: appl3.Appl_LastUpdate_Dte));
